...
if exists("g:qb_hotkey_1") && g:qb_hotkey_1 != ""
	exe "nnoremap <unique>" g:qb_hotkey_1 ":cal <SID>init(1)<cr>:cal SBRun()<cr>"
endif

if exists("g:qb_hotkey_2") && g:qb_hotkey_2 != ""
	exe "nnoremap <unique>" g:qb_hotkey_2 ":cal <SID>init(1)<cr>:cal SBRun()<cr>"
endif
